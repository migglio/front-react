...
class Login extends React.Component{
    ...
    render () {
        return (
            <div style={{textAlign:'center',margin:'auto',width:'20%',marginTop:'5%'}}>
                {this.state.redirect}
                ...
                <TextField
                    ...
                    />
                    <br/>
                <Button  color="primary" variant="raised" disabled={!this.state.formValid} className='bttn' onClick={this.processForm}>
                    Login
                </Button>
                </div>
                    <FacebookLogin
