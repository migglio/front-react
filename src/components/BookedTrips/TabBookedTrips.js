  ...
  render() {
    ...
    return (
      <div className={classes.root}>
        ...
        >
          <TabContainer dir={theme.direction}> {this.renderTrips(this.props.trips.users, "No has realizado viajes hasta el momento")}</TabContainer>
          <TabContainer dir={theme.direction}>{this.renderNextTrips(this.props.trips.users, "No has realizado viajes hasta el momento")}</TabContainer>
          <TabContainer dir={theme.direction}> {this.renderNextTrips(this.props.trips.pendingUsers, "No tienes reservas por confirmar")}</TabContainer>
        </SwipeableViews>
      </div>
    );
  }
...
export default withStyles(styles, { withTheme: true })(TabBookedTrips);
